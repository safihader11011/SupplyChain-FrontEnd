...
const CreateBlockRetailerModal = ({blockchains,setOpen }) => {
        ...
        >
          {
            ...
            <div> 
            <Grid container justify="center">
             <Typography variant="h4" style={{textAlign:"center"}} className={classes.bold}>Add Retailer Informaion</Typography>
            </Grid>
            ...
            <Input id="items" variant="outlined" style={{width:"100%"}} label="Total Numbers of Items Recieved" placeholder="Total Numbers of Items Recieved" onChange={onChange} />
            {error && (error.items) && <Error text={error.items}/>}
            
            <Input id="expiry" variant="outlined" style={{width:"100%"}} label="Check Expiry Date" placeholder="Check Expiry Date" onChange={onChange} />
            {error && (error.expiry) && <Error text={error.expiry}/>}

            <Input id="profit" variant="outlined" style={{width:"100%"}} label="Price of Profit" placeholder="Price of Profit" onChange={onChange} />
            {error && (error.profit) && <Error text={error.profit}/>}
 
            <Input id="price" variant="outlined" style={{width:"100%"}} label="Final Price of Product" placeholder="Final Price of Product" onChange={onChange} />
            {error && (error.price) && <Error text={error.price}/>}
 
            <Input id="sold" variant="outlined" style={{width:"100%"}} label="Total Number of Items Sold" placeholder="Total Number of Items Sold" onChange={onChange} />
            {error && (error.sold) && <Error text={error.sold}/>}
 
            <Input id="left" variant="outlined" style={{width:"100%"}} label="Total Items Left" placeholder="Total Items Left" onChange={onChange} />
            {error && (error.left) && <Error text={error.left}/>}
...
export default CreateBlockRetailerModal;